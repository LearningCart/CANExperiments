# https://www.waveshare.com/rp2350-can.htm
# Wavesahre Raspberry Pi Pico 2 RP2350 CAN example modified to send 
# periodic ON and OFF messages to Arduino Nodes connected to MCP2515 CAN Module TJA1050
# MicroPython
...
class RP2350_CAN:
    def __init__(self, rate_kbps = "500KBPS", spi_cs = XL2515_CS_PIN, irq = XL2515_INT_PIN, spi_port = XL2515_SPI_PORT, spi_clk = XL2515_SCLK_PIN,spi_mosi = XL2515_MOSI_PIN, spi_miso = XL2515_MISO_PIN,  spi_freq=10_000_000):
        self.can_rate_arr = {
